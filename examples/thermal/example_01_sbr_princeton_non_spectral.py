...
This example is for a NSRDB* dataset without spectral irradiance data
...
config_dict = {'irrad_model': 'vf',     # Irradiation model. "vf" or "simple"
               ...
               'spectral': False        # Set, whether NSRDB data is spectral or not
              }

# Load NSRDB data and populate the "loc_data" dictionary
nsrdb_data_filepath = 'data_thermal/princeton_1223393_40.33_-74.66_tmy-2024.csv'
